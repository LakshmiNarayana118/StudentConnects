  ...
  return (
    <header className="sticky top-0 z-40 bg-white dark:bg-[#1D2226] flex items-center justify-around py-1.5 px-3 focus-within:shadow-lg">
      ...
      <div className="flex items-center space-x-2 w-full max-w-xs">
        {mounted && (
          <>
            {resolvedTheme === "dark" ? (
              <Link href="/home">
              <a><Image src={image} width={55} height={55} />
              </a>
              </Link>
            ) : (
              <Link href="/home">
      ...
      <div className="flex items-center space-x-6">
        <HeaderLink Icon={HomeRoundedIcon} text="Home" feed hlink="/"/>
        ...
        <HeaderLink Icon={CastForEducationIcon} text="Learning" hlink="learning" feed />
        {/* <HeaderLink Icon={NotificationsIcon} text="Notifications" feed /> */}
        <HeaderLink Icon={AppsOutlinedIcon} text="News" hlink="techNews" feed />
